...
const markup = (title: string, pubDate: string) =>
	html`<div tw="flex flex-col w-full h-full bg-[#181825] text-[#89b4fa]">
		<div tw="flex flex-col flex-1 w-full p-3 justify-center">
			<p tw="text-2xl mb-4 font-semibold text-[#a6e3a1]">${pubDate}</p>
			<h1 tw="text-5xl font-bold leading-snug">${title}</h1>
		</div>
		<div tw="flex items-center justify-between w-full p-2 border-t border-[#cba6f7] text-2xl text-[#f9e2af] font-bold">
